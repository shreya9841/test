        ...
        <div>
            <table class="border border-black  ">
                <tr>
                    ...
                    <th class="border border-black px-2 py-2">Remaining Amount</th>
                    <th class="border border-black px-2 py-2">View</th>
                    <th class="border border-black px-2 py-2">Edit</th>
                    <th class="border border-black px-2 py-2">Pay</th>

                </tr>
                @foreach($users as $item)
                <tr class="border border-black px-2 py-2">
                    <td class="border border-black px-2 py-2">{{$item->id}}</td>
                    <td class="border border-black px-2 py-2">{{$item->name}}</td>
                    <td class="border border-black px-2 py-2"> {{$item->email}}</td>
                    ...
                    <td class="border border-black px-2 py-2">
                     ...
                     <td class="border border-black px-2 py-2">
                        <a href="{{ url('/users/' . $item->id . '/details/pay') }}"
